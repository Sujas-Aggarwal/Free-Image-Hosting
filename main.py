...
if __name__=="__main__":
    ...
    # FreeImageHoster.GetDirectLink("https://postimg.cc/3dKbQG6R")
    print(Addons.UploadImageOnFreeHost("input/IMG20240813225308-removebg-preview (1).png","IMG20240813225308-removebg-preview (1).png"))
